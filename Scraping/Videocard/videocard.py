...
def get_api_id():
    ...
    with open("Scraping//Videocard//index.html", "w", encoding="utf-8") as file:
        file.write(response.text)

    with open("Scraping//Videocard//index.html", encoding="utf-8") as file:
        page = file.read()
...
def data_write_json_csv(link_api):
    ...
    for ind, item in enumerate(link_api):
        ...
        with open("Scraping//Videocard//api.json", "w", encoding="utf-8") as file:
            json.dump(response.json(), file, indent=4, ensure_ascii=False)

        with open("Scraping//Videocard//api.json", encoding="utf-8") as file:
            js = json.load(file)
    ...
    with open(f"Scraping//Videocard//result.json", "w", encoding="utf-8") as file:
